  ...
  return (
    <RefDataProvider>
      <div className="min-h-screen bg-slate-100 font-sans text-slate-700">
        ...
        {/* Header only shown in normal mode */}
        {!hideSearch && (
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
                ...
                <table className="w-full text-left text-xs">
                  ...
                  <tbody>
                    {currentResults.length > 0 ? (
                      currentResults.map((row: any, i: number) => (
                        <tr
          ...
          <div className="w-full">
            ...
            (!searchInitiated ||
              isLoading ||
              (results?.length > 0 && !selectedRecord)) ? (
          ...
          {/* Done Button at Bottom in Direct Mode */}
          {hideSearch && (
