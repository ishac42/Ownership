  ...
  return (
    <RefDataProvider>
      <div className="min-h-screen bg-slate-100 font-sans text-slate-700">
        ...
        {/* Nav — hidden in direct/embed mode */}
        {!hideSearch && (
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
          ...
          {/* Section 1: Search & Table — hidden in direct/embed mode */}
          {!hideSearch && (
            <>
              <SearchControls 
            ...
            <div className="flex border rounded shadow-sm bg-white overflow-hidden">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 text-xs font-bold ${
                  viewMode === 'list' ? 'bg-[#24417a] text-white' : 'text-slate-600'
                }`}
              >
          ...
          {/* Section 4: Done Button — only in direct/embed mode */}
          {hideSearch && (
            <div className="flex justify-end pt-2 pb-6">
              <button
                onClick={handleDone}
                className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-2.5 rounded-md font-bold transition-colors shadow-md"
              >
                <CheckCircle size={18} />
                Done
              </button>
